...
exports.init = function(genericAWSClient) {
  ...
  var createFPSClient = function (accessKeyId, secretAccessKey, options) {
    options = options || {};
  options.area = options.area == "live" ? "live" : "sandox";
  var urls = {
    "live" : {
  ...
  obj.signed_service_url = function(query, callback) {
    query["callerKey"] ||= obj.accessKeyId;
    query["signatureMethod"] = "HmacSHA256";
    query["signatureVersion"] = "2";
    query["version"] = obj.service_version || "2009-01-09";
    query["signature"] = aws.sign(query);
    query["cobrandingUrl"] ||= obj.cobrandingUrl;
    query["websiteDescription"] ||= obj.websiteDescription;
